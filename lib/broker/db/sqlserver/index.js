...
Database.prototype.storeInstance = function(req, result, callback) {
  var db = this;
...
Database.prototype.deleteInstance = function(req, result, callback) {
  var db = this;
  var instanceId = req.params.instance_id;
...
Database.prototype.updateInstance = function(req, result, callback) {
  var db = this;
  var instanceId = req.params.instance_id;
...
Database.prototype.storeBinding = function(req, result, callback) {
  var db = this;
...
Database.prototype.deleteBinding = function(req, result, callback) {
  var db = this;
