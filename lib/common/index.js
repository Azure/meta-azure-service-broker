...
var validateConfigurations = function() {
  var requiredEnvNames = [
    ...
    'AZURE_BROKER_DATABASE_PROVIDER', 'AZURE_BROKER_DATABASE_SERVER', 'AZURE_BROKER_DATABASE_USER', 'AZURE_BROKER_DATABASE_PASSWORD', 'AZURE_BROKER_DATABASE_NAME', 'AZURE_BROKER_DATABASE_ENCRYPTKEY'
  ];
...
module.exports.getConfigurations = function() {
  ...
  var config = {
    ...
    'database': {
      ...
      'encryptKey': process.env['AZURE_BROKER_DATABASE_ENCRYPTKEY']
    }
  };
  return config;
};
