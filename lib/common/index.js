...
module.exports.getConfigurations = function() {
  var newConfig = {
    'azure': {
      ...
      'docdbHostendpoint': fetchConfigFromEnv(defaultConfig.azure.docdbHostendpoint, 'DOCDB_HOSTENDPOINT'),
      'docdbMasterkey': fetchConfigFromEnv(defaultConfig.azure.docdbMasterkey, 'DOCDB_MASTERKEY')
    },
    'serviceBroker': {
      'credentials': {
