...
exports.getToken = function(azure_config, callback) {
  request({
    url: '{0}/{1}/oauth2/token'.format(environment.activeDirectoryEndpointUrl, azure_properties.tenantId),
...
exports.createResourceGroup = function(azure_config, accessToken, callback){
  request({
    url: '{0}/subscriptions/{1}/resourceGroups/{2}'.format(environment.resourceManagerEndpointUrl, azure_properties.subscriptionId, azure_config.resourceGroupName),
...
exports.createNamespace = function(azure_config, accessToken, callback) {
  request({
    url: '{0}/subscriptions/{1}/resourceGroups/{2}/providers/Microsoft.ServiceBus/namespaces/{3}'.format(environment.resourceManagerEndpointUrl, azure_properties.subscriptionId, azure_config.resourceGroupName, azure_config.namespaceName),
...
exports.getNamespace = function(azure_config, accessToken, callback) {
  request({
    url: '{0}/subscriptions/{1}/resourceGroups/{2}/providers/Microsoft.ServiceBus/namespaces/{3}'.format(environment.resourceManagerEndpointUrl, azure_properties.subscriptionId, azure_config.resourceGroupName, azure_config.namespaceName),
    qs: {'api-version' : API_VERSIONS.SERVICE_BUS_NAMESPACE},
    method: 'GET',
...
exports.listNamespaceKeys = function(azure_config, accessToken, callback) {
  request({
    url: '{0}/subscriptions/{1}/resourceGroups/{2}/providers/Microsoft.ServiceBus/namespaces/{3}/authorizationRules/RootManageSharedAccessKey/ListKeys'.format(environment.resourceManagerEndpointUrl, azure_properties.subscriptionId, azure_config.resourceGroupName, azure_config.namespaceName),
    qs: {'api-version' : API_VERSIONS.SERVICE_BUS_NAMESPACE},
    method: 'POST',
    headers: {
        'Authorization': 'Bearer ' + accessToken
