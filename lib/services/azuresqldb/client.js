...
sqldbOperations.prototype.createServer = function (parameters, callback) {
    ...
    that.PUT(that.sqlServerUrl, that.standardHeaders, parameters.sqlServerParameters, API_VERSION_FOR_SQL, function (err, res, body) {
...
sqldbOperations.prototype.getDatabase = function (parameters, callback) {
