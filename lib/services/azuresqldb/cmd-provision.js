...
var sqldbProvision = function (log, params) {
    ...
    this.depreciatedParametersWereProvided = function () {
        if (!_.isUndefined(params.parameters.sqlServerCreateIfNotExist)) {
            log.error('SqlDb Provision: The parameter sqlServerCreateIfNotExist is depreciated. Please remove it from your parameters, and try again');
            return false;
        }
        return true;
    };
    ...
    this.allValidatorsSucceed = function () {
        return this.resourceGroupWasProvided() &&
            ...
            this.depreciatedParametersWereProvided();
    };
};
