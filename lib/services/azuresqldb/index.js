...
Handlers.provision = function (log, params, next) {
  ...
  if (invalidParams.length !== 0) {
    return common.handleServiceErrorEx(log, HttpStatus.BAD_REQUEST, util.format('Parameter validation failed. Please check your parameters: %s', invalidParams.join(', ')), next);
  }
