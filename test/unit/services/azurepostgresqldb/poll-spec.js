...
var cmdPoll = require('../../../../lib/services/azurepostgresqldb/cmd-poll');
...
describe('PostgreSqlDb - Poll - polling postgresql server immediately after creation is started', function () {
    ...
    describe('Poll immediately after starting to provision postgresql server', function () {
        it('should return \'in progress\'', function (done) {
            cp.poll(postgresqldbOps, function (err, result) {
                ...
                result.body.postgresqlServerName.should.equal('golive4');
...
describe('PostgreSqlDb - Poll - polling postgresql server after creation is complete', function () {

    var postgresqldbOpsGetDatabaseResult = {
        statusCode: 200,
        body: {
            name: 'postgresql',
            properties: {
    ...
    before(function () {
        ...
        msRestRequest.GET.withArgs('https://management.azure.com//subscriptions/55555555-4444-3333-2222-111111111111/resourceGroups/sqldbResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/golive4')
          .yields(null, postgresqldbOpsGetDatabaseResult, JSON.stringify(postgresqldbOpsGetDatabaseResult.body));
        msRestRequest.PUT = sinon.stub();
        // create firewall rule
        msRestRequest.PUT.withArgs('https://management.azure.com//subscriptions/55555555-4444-3333-2222-111111111111/resourceGroups/sqldbResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/golive4/firewallRules/newrule')
        ...
        msRestRequest.GET.withArgs('fake-firewall-polling-url')
          .yields(null, {statusCode: 200}, '{"name":"8772dacd-eb4a-4a59-b81b-6af617bcc010","status":"Succeeded","startTime":"2017-04-19T05:39:13.033Z"}');
        // create db
        msRestRequest.PUT.withArgs('https://management.azure.com//subscriptions/55555555-4444-3333-2222-111111111111/resourceGroups/sqldbResourceGroup/providers/Microsoft.DBforPostgreSQL/servers/golive4/databases/mydb')
    ...
    describe('created server, but not created firewall rules', function () {
        it('should return \'in progress\'', function (done) {
            ...
            cp.poll(postgresqldbOps, function (err, result) {
                ...
                result.body.resourceGroup.should.equal('sqldbResourceGroup');
                result.body.postgresqlServerName.should.equal('golive4');
                result.body.postgresqlDatabaseName.should.equal('mydb');
                result.body.administratorLogin.should.equal('xxxx');
                result.body.administratorLoginPassword.should.equal('xxxxxxx');
...
describe('PostgreSqlDb - Poll - polling postgresql server after de-provision is complete', function () {
